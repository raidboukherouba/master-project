...
const analyzeSentimentAragpt2 = async (req, res) => {
  const { text } = req.body;
  ...
  try {
    const response = await axios.post('http://flask-api:8000/transformers/aragpt2', { text });
...
module.exports = { analyzeSentimentAragpt2 };