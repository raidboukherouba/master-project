...
const analyzeSentimentDistilBertCased = async (req, res) => {
  const { text } = req.body;
  ...
  try {
    const response = await axios.post('http://flask-api:8000/transformers/distil-bert-cased', { text });
...
module.exports = { analyzeSentimentDistilBertCased };