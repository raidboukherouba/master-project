...
class NbmModel:
    def __init__(self, model_dir):
        self.vectorizer = joblib.load(os.path.join(model_dir, "nb_b_tfidf_vectorizer.pkl"))
        self.selector = joblib.load(os.path.join(model_dir, "nb_b_select_best.pkl"))
        self.model = joblib.load(os.path.join(model_dir, "binomial_model.pkl"))
